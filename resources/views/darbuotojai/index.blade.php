        ...
        <div class="rounded-lg shadow hidden md:block xl:mx-60">
            <table class="w-full">
                <thead class="bg-gray-50 border-b-2 border-gray-200">
                    <tr>
                        <th class="w-20 p-3 text-sm font-semibold tracking-wide text-left">Vardas</th>
                        <th class="p-3 text-sm font-semibold tracking-wide text-left">Pavarde</th>
                        <th class="w-24 p-3 text-sm font-semibold tracking-wide text-left">Pareigos</th>
                        <th class="w-24 p-3 text-sm font-semibold tracking-wide text-left">Elektroninis paštas</th>
                        <th class="w-24 p-3 text-sm font-semibold tracking-wide text-left">Telefono numeris</th>
